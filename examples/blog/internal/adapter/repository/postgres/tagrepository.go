...
// SQL: INSERT INTO tags (id, name, slug, description) VALUES ($1, $2, $3, $4)
// ============================================================================
...
// SQL: UPDATE tags SET name = $1, slug = $2, description = $3 WHERE id = $4
// ============================================================================
...
// SQL: SELECT id, name, slug, description FROM tags WHERE id = $1 LIMIT 1 FOR UPDATE
// ============================================================================
