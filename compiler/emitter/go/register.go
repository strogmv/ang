...
func Register(registry *generator.StepRegistry, in RegisterInput) {
	...
	goRedis := []compiler.Capability{compiler.CapabilityProfileGoLegacy, compiler.CapabilityUsesRedisClient}
	goMongo := []compiler.Capability{compiler.CapabilityProfileGoLegacy, compiler.CapabilityUsesMongo}
	goS3 := []compiler.Capability{compiler.CapabilityProfileGoLegacy, compiler.CapabilityUsesS3}
	...
	registry.Register(generator.Step{Name: "RBAC", ParallelSafe: true, Requires: goOnly, Run: func() error { return in.Em.EmitRBAC(in.RBACDef) }})
	registry.Register(generator.Step{Name: "Helpers", ParallelSafe: true, Requires: goOnly, Run: func() error { return in.Em.EmitHelpers() }})
	registry.Register(generator.Step{Name: "ReqCtx", ParallelSafe: true, Requires: goOnly, Run: func() error { return in.Em.EmitReqCtx() }})
	registry.Register(generator.Step{Name: "Session Middleware", ParallelSafe: true, Requires: goHTTP, Run: func() error { return in.Em.EmitSessionMiddleware(in.SessionDef) }})
	...
	registry.Register(generator.Step{Name: "DI Container", ArtifactKey: "go:di_container", ParallelSafe: true, Requires: nil, Run: func() error { return in.Em.EmitContainer() }})
	...
	registry.Register(generator.Step{Name: "Policy Port", Requires: goOnly, Run: func() error { return in.Em.EmitPolicyPort() }})
