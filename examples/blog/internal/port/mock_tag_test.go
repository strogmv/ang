...
type TagRepositoryMock struct {
	...
	InsertFunc     func(ctx context.Context, item *domain.Tag) error
	UpdateFunc     func(ctx context.Context, item *domain.Tag) error
...
func (m *TagRepositoryMock) Insert(ctx context.Context, item *domain.Tag) error {
	if m.InsertFunc != nil {
...
func (m *TagRepositoryMock) Update(ctx context.Context, item *domain.Tag) error {
	if m.UpdateFunc != nil {
...
func (m *TagRepositoryMock) LockByID(ctx context.Context, id string) (*domain.Tag, error) {
