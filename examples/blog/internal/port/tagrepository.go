...
type TagRepository interface {
	...
	Insert(ctx context.Context, entity *domain.Tag) error
	Update(ctx context.Context, entity *domain.Tag) error
	LockByID(ctx context.Context, id string) (*domain.Tag, error)
