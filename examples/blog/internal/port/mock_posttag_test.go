...
type PostTagRepositoryMock struct {
	...
	InsertFunc       func(ctx context.Context, item *domain.PostTag) error
	UpdateFunc       func(ctx context.Context, item *domain.PostTag) error
...
func (m *PostTagRepositoryMock) Insert(ctx context.Context, item *domain.PostTag) error {
	if m.InsertFunc != nil {
...
func (m *PostTagRepositoryMock) Update(ctx context.Context, item *domain.PostTag) error {
	if m.UpdateFunc != nil {
...
func (m *PostTagRepositoryMock) LockByID(ctx context.Context, id string) (*domain.PostTag, error) {
