...
type CommentRepository interface {
	...
	Insert(ctx context.Context, entity *domain.Comment) error
	Update(ctx context.Context, entity *domain.Comment) error
	LockByID(ctx context.Context, id string) (*domain.Comment, error)
