...
type PostRepositoryMock struct {
	...
	InsertFunc                func(ctx context.Context, item *domain.Post) error
	UpdateFunc                func(ctx context.Context, item *domain.Post) error
...
func (m *PostRepositoryMock) Insert(ctx context.Context, item *domain.Post) error {
	if m.InsertFunc != nil {
...
func (m *PostRepositoryMock) Update(ctx context.Context, item *domain.Post) error {
	if m.UpdateFunc != nil {
...
func (m *PostRepositoryMock) LockByID(ctx context.Context, id string) (*domain.Post, error) {
