...
func ConvertAuth(a *normalizer.AuthDef) *Auth {
	return &Auth{
		Mode:           a.Mode,
		BearerFallback: a.BearerFallback,
		Algorithm:      a.Alg,
		Issuer:         a.Issuer,
		Audience:       a.Audience,
		...
		Operations: AuthOps{
			...
			RegisterOp:              a.RegisterOp,
			RegisterAccessField:     a.RegisterAccessField,
			RegisterRefreshField:    a.RegisterRefreshField,
			DemoSessionOp:           a.DemoSessionOp,
			DemoSessionAccessField:  a.DemoSessionAccessField,
			DemoSessionRefreshField: a.DemoSessionRefreshField,
