...
type CommentRepositoryMock struct {
	...
	InsertFunc         func(ctx context.Context, item *domain.Comment) error
	UpdateFunc         func(ctx context.Context, item *domain.Comment) error
...
func (m *CommentRepositoryMock) Insert(ctx context.Context, item *domain.Comment) error {
	if m.InsertFunc != nil {
...
func (m *CommentRepositoryMock) Update(ctx context.Context, item *domain.Comment) error {
	if m.UpdateFunc != nil {
...
func (m *CommentRepositoryMock) LockByID(ctx context.Context, id string) (*domain.Comment, error) {
