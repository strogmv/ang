...
func (r *UserRepository) FindByID(ctx context.Context, id string) (*domain.User, error) {
	...
	row := exec.QueryRow(ctx, `
		SELECT id, email, passwordhash, name, role, avatarurl, createdat, updatedat
		FROM users
		WHERE id = $1
		LIMIT 1
	`, id)
...
// SQL: INSERT INTO users (id, email, passwordhash, name, role, avatarurl, createdat, updatedat) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
// ============================================================================
...
// SQL: UPDATE users SET email = $1, passwordhash = $2, name = $3, role = $4, avatarurl = $5, createdat = $6, updatedat = $7 WHERE id = $8
// ============================================================================
func (r *UserRepository) Update(ctx context.Context, entity *domain.User) error {
	...
	tag, err := exec.Exec(ctx, `
		UPDATE users
		SET email = $1, passwordhash = $2, name = $3, role = $4, avatarurl = $5, createdat = $6, updatedat = $7
		WHERE id = $8
	`, entity.Email, entity.PasswordHash, entity.Name, entity.Role, entity.AvatarURL, entity.CreatedAt, entity.UpdatedAt, entity.ID)
	if err != nil {
		return err
	}
...
// SQL: SELECT id, email, passwordhash, name, role, avatarurl, createdat, updatedat FROM users WHERE id = $1 LIMIT 1 FOR UPDATE
// ============================================================================
