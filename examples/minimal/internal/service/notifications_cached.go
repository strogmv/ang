...
func (c *NotificationsCached) SendNoticeEmail(ctx context.Context, req port.SendNoticeEmailRequest) (port.SendNoticeEmailResponse, error) {
	return c.base.SendNoticeEmail(ctx, req)
}
