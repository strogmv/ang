...
type Notifications interface {
	...
	SendNoticeEmail(ctx context.Context, req SendNoticeEmailRequest) (SendNoticeEmailResponse, error)
...
type SendNoticeEmailRequest struct {
	Email string `json:"email"`
	Name  string `json:"name"`
...
func (d *SendNoticeEmailRequest) Validate() error {
	return nil
}

type SendNoticeEmailResponse struct {
	Ok bool `json:"ok"`
}

func (d *SendNoticeEmailResponse) Validate() error {
	return nil
}
