...
import { useUpdateCommentForm } from '../../forms';
import { useUpdateComment } from '../../hooks';
import type { UpdateCommentRequest, UpdateCommentResponse } from '../../types';
...
export interface UpdateCommentFormProps {
  ...
  onCancel?: () => void;
  defaultValues?: Partial<UpdateCommentRequest>;
}
...
// MUTATION: useUpdateComment hook for API call
// ============================================================================
export function UpdateCommentForm({ onSuccess, onError, onCancel, defaultValues }: UpdateCommentFormProps) {
  const form = useUpdateCommentForm({ defaultValues });
