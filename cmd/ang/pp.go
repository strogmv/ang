...
func printPPUsage() {
	...
	fmt.Println("                                  [--expert-pack ID] [--json]")
	fmt.Println("  ang pp init [path]              Render consumer .ang/init templates into [path]")
	fmt.Println("                                  --sid SID --label LABEL [--name NAME] [--package PKG]")
	fmt.Println("                                  [--module MODULE] [--init-dir DIR] [--ticket SUMMARY]")
	fmt.Println("                                  [--knowledge ID] [--force]")
