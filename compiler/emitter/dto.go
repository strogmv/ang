...
func (e *Emitter) EmitDTO(entities []ir.Entity) error {
	...
	if err := pruneGeneratedFiles(
		...
		func(path string) bool {
			return fileContainsAny(path, "AUTO-GENERATED by ANG", "DO NOT EDIT - changes will be overwritten on next generation")
		},
	); err != nil {
		return fmt.Errorf("prune stale DTO files: %w", err)
	}
